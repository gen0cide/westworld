...
public final class client extends e {
   ...
   private final void a(boolean var1, byte var2) {
      ...
      try {
         ...
         int var12 = var8 * var11 + var10 * var9 >> 18;
         var9 = -(var8 * var10) + var9 * var11 >> 18;
         var8 = var12;
         ...
         while (true) {
            if (var13 < this.Ah) {
               ...
               var12 = var11 * var8 + var10 * var9 >> 18;
         ...
         while (true) {
            if (~var13 > ~this.de) {
               ...
               var12 = var9 * var10 - -(var8 * var11) >> 18;
               var9 = -(var8 * var10) + var11 * var9 >> 18;
               var8 = var12;
         ...
         while (true) {
            ...
            while (var10000 > var13) {
               ...
               var12 = var8 * var11 + var10 * var9 >> 18;
               var9 = var11 * var9 - var8 * var10 >> 18;
               var8 = var12;
               int var15 = 16777215;
   ...
   private final void s(int var1) {
      ...
      try {
         ...
         if (1 == this.Zh && this.yd.a((byte)-107, this.Fh) || ~this.Zh == -4 && this.yd.a((byte)-116, this.mc)) {
            ...
            if (-3 == ~(var3 >> 16) || this.Yh && 1 == var3 >> 16) {
               int var4 = 65535 & var3;
         ...
         try {
                        ...
                        label2004: {
                           ...
                           if (0 != var171) {
                              ...
                              if (~var175 != -1) {
                                 ...
                                 var161.D = (var177 << 2) - -this.mg.f(-98, 2);
                                 if (!var17) {
                                    break label1868;
                                 }
                              }
            ...
            if (99 == var1) {
               ...
               while (true) {
                  ...
                  while (true) {
                     ...
                     int var56 = 0;
                     int var77 = this.Lf + this.mg.h(20869) >> 3;
                     int var93 = this.sh - -this.mg.h(20869) >> 3;
                     int var108 = 0;

                     while (~var108 > ~this.Ah) {
                        int var122 = -var77 + (this.Zf[var108] >> 3);
                        int var145 = (this.Ni[var108] >> 3) + -var93;
                        var192 = var122;
                        if (var17) {
                           continue label1818;
                        }
            ...
            if (-49 == ~var1) {
               ...
               while (true) {
                  ...
                  while (var190 > var199) {
                     ...
                     int var54 = 0;
                     int var75 = this.Lf - -this.mg.h(20869) >> 3;
                     int var91 = this.sh + this.mg.h(20869) >> 3;
                     int var105 = 0;

                     while (~var105 > ~this.eh) {
                        int var120 = (this.Se[var105] >> 3) + -var75;
                        int var144 = (this.ye[var105] >> 3) + -var91;
                        var190 = -1;
                        var199 = ~var120;
                        if (var17) {
                           continue label1753;
            ...
            if (var1 == 91) {
               ...
               while (true) {
                  ...
                  while (true) {
                     ...
                     int var49 = 0;
                     int var70 = this.Lf - -this.mg.h(20869) >> 3;
                     int var87 = this.sh + this.mg.h(20869) >> 3;
                     int var101 = 0;

                     while (this.hf > var101) {
                        int var115 = -var70 + (this.Jd[var101] >> 3);
                        int var132 = (this.yk[var101] >> 3) - var87;
                        var187 = 0;
                        var197 = var115;
                        if (var17) {
                           continue label1614;
                     ...
                     if (!var17) {
                        label2028: {
                           ...
                           if (0 != var99) {
                              ...
                              var85.D = this.mg.f(-127, 2) + (var130 << 2);
                           }
            ...
            if (var1 == 211) {
               ...
               while (true) {
                  ...
                  label1333:
                  while (var183 > var195) {
                     int var83 = this.Lf - -this.mg.a(false) >> 3;
                     int var97 = this.sh - -this.mg.a(false) >> 3;
                     int var111 = 0;
                     int var124 = 0;

                     while (true) {
                        if (var124 < this.Ah) {
                           int var10 = -var83 + (this.Zf[var124] >> 3);
                           int var11 = -var97 + (this.Ni[var124] >> 3);
                           var183 = var10;
                           if (var17) {
                              break;
                           }
                     ...
                     while (true) {
                        if (var124 < this.eh) {
                           int var148 = -var83 + (this.Se[var124] >> 3);
                           int var163 = (this.ye[var124] >> 3) - var97;
                           var183 = var148;
                           if (var17) {
                              break;
                           }
                     ...
                     while (this.hf > var124) {
                        int var149 = (this.Jd[var124] >> 3) + -var83;
                        int var164 = (this.yk[var124] >> 3) - var97;
                        var183 = 0;
                        var195 = var149;
                        if (var17) {
                           continue label1333;
