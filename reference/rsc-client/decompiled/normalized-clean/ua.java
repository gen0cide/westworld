...
class ua implements ImageProducer, ImageObserver {
   ...
   final void b(int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      ...
      try {
         ...
         int var8 = (var4 & 16747974) >> 16;
         int var9 = var4 >> 8 & 0xFF;
         int var10 = var4 & 0xFF;
         int var11 = (var2 & 16767844) >> 16;
         ...
         while (var5 > var17 && !var20) {
            label76: {
               if (~(var17 + var6) <= ~this.A && var6 + var17 < this.Rb) {
                  int var18 = ((var9 * var17 + var12 * (-var17 + var5)) / var5 << 8)
                     + ((var11 * (-var17 + var5) + var8 * var17) / var5 << 16)
   ...
   static final void a(int var0, int[] var1, int var2, int[] var3, int var4, int var5, int var6, int var7) {
      ...
      try {
         ...
         if (-1 < ~var2) {
            ...
            while (true) {
               if (-1 < ~var9) {
                  var3[var6++] = var4 - -ib.a(8355711, var3[var6] >> 1);
                  var3[var6++] = var4 + ib.a(8355711, var3[var6] >> 1);
                  var3[var6++] = var4 + (ib.a(var3[var6], 16711423) >> 1);
                  var3[var6++] = (ib.a(16711423, var3[var6]) >> 1) + var4;
                  var4 = var1[0xFF & var0 >> 8];
                  var0 += var5;
                  var3[var6++] = ib.a(var3[var6] >> 1, 8355711) + var4;
                  var3[var6++] = ib.a(var3[var6] >> 1, 8355711) + var4;
                  var3[var6++] = (ib.a(16711423, var3[var6]) >> 1) + var4;
                  var3[var6++] = ib.a(var3[var6] >> 1, 8355711) + var4;
                  var4 = var1[var0 >> 8 & 0xFF];
                  var3[var6++] = (ib.a(var3[var6], 16711422) >> 1) + var4;
                  var0 += var5;
                  var3[var6++] = (ib.a(16711423, var3[var6]) >> 1) + var4;
                  var3[var6++] = var4 - -ib.a(var3[var6] >> 1, 8355711);
                  var3[var6++] = var4 + ib.a(8355711, var3[var6] >> 1);
                  var4 = var1[(65302 & var0) >> 8];
                  var0 += var5;
                  var3[var6++] = (ib.a(var3[var6], 16711423) >> 1) + var4;
                  var3[var6++] = var4 + ib.a(var3[var6] >> 1, 8355711);
                  var3[var6++] = var4 - -(ib.a(var3[var6], 16711423) >> 1);
                  var3[var6++] = var4 + (ib.a(16711423, var3[var6]) >> 1);
                  var4 = var1[var0 >> 8 & 0xFF];
                  var0 += var5;
                  var9++;
                  if (var10) {
            ...
            while (var19 < ~var8) {
               ...
               while (true) {
                  ...
                  while (true) {
                     ...
                     this.rb[var8 + var9 * this.u] = var12 / var13 + (var10 / var13 << 16) + (var11 / var13 << 8);
                     var9++;
                     if (var17) {
                        break label90;
                     }
         ...
         try {
            ...
            if (this.Qb[var3]) {
               ...
               if (~(this.Sb[var3] * var7 % var14) != -1) {
                  var10 = (-(this.Sb[var3] * var7 % var14) + var14 << 16) / var7;
               }
               ...
               if (-1 != ~(this.G[var3] * var5 % var15)) {
                  var11 = (-(var5 * this.G[var3] % var15) + var15 << 16) / var5;
               }

               var5 = var5 * (-(var11 >> 16) + this.R[var3]) / var15;
               var7 = (-(var10 >> 16) + this.kb[var3]) * var7 / var14;
            }
   ...
   final void b(int var1) {
      ...
      try {
         ...
         while (var4 > var3) {
            ...
            this.rb[var3] = ib.a(var2 >>> 4, 986895)
               + ((ib.a(var2, 16316665) >>> 3) + (ib.a(16711423, var2) >>> 1) - -ib.a(-2143338689, var2 >>> 2));
            var3++;
            if (var5 || var5) {
               break;
            }
   ...
   private final void a(int var1, int var2, int var3, int[] var4, int var5, int var6, int var7, int[] var8, int var9, int var10, boolean var11) {
      ...
      try {
         ...
         while (true) {
            if (var3 < 0) {
               this.rb[var10++] = var8[(var6 >> 17) * var2 + (var7 >> 17)];
               var7 += var5;
               var6 += var9;
               var3++;
               if (var13) {
   ...
   final void c(int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      ...
      try {
         ...
         int var8 = 256 - var1;
         int var9 = var1 * (var7 >> 16 & 0xFF);
         int var10 = ((var7 & 65476) >> 8) * var1;
         ...
         while (~var3 < ~var18 && !var21) {
            ...
            while (true) {
               if (0 > var19) {
                  ...
                  int var12 = var8 * ((16746549 & this.rb[var17]) >> 16);
                  int var13 = var8 * ((65402 & this.rb[var17]) >> 8);
                  int var20 = (var14 + var11 >> 8) + (var13 + var10 >> 8 << 8) + (var9 + var12 >> 8 << 16);
                  this.rb[var17++] = var20;
                  var19++;
                  if (var21) {
                     break;
   ...
   private final void a(int var1, int var2, int var3, int[] var4, int[] var5, int var6, int var7, int var8, int var9, int var10, byte var11) {
      ...
      try {
         ...
         if (var11 == 102) {
            while (-1 < ~var12) {
               var10 = var4[(var6 >> 17) * var8 + (var3 >> 17)];
               var3 += var9;
               if (var13) {
                  break;
               }
   ...
   final void c(int var1, int var2, int var3, int var4, int var5, int var6) {
      ...
      try {
         X++;
         int var7 = -var1 + 256;
         int var8 = var1 * (0xFF & var5 >> 16);
         int var9 = (0xFF & var5 >> 8) * var1;
            ...
            while (var15 >= var17) {
               ...
               while (true) {
                  if (var21 >= var23) {
                     ...
                     int var12 = var7 * ((65493 & this.rb[var22]) >> 8);
                     int var11 = var7 * ((this.rb[var22] & 16718009) >> 16);
                     int var24 = (var13 + var10 >> 8) + (var9 - -var12 >> 8 << 8) + (var8 - -var11 >> 8 << 16);
                     this.rb[var22++] = var24;
                     var23++;
                     if (var25) {
                        break;
   ...
   private final void a(
      ...
      try {
         a++;
         int var21 = var15 >> 16 & 0xFF;
         int var22 = var15 >> 8 & 0xFF;
         int var23 = var15 & 0xFF;
         int var24 = var8 >> 16 & 0xFF;
         if (var6 != 1603920392) {
            this.Rb = 29;
         }

         int var25 = var8 >> 8 & 0xFF;
         int var26 = 0xFF & var8;
               ...
               label109: {
                  ...
                  if (0 != var12) {
                     ...
                     while (var30 + var31 > var37) {
                        ...
                        label103:
                        if (-1 != var10001) {
                           int var18 = 0xFF & var7 >> 16;
                           int var19 = 0xFF & var7 >> 8;
                           int var20 = var7 & 0xFF;
                           if (var18 == var19 && var20 == var19) {
                              var1[var37 - -var17] = (var20 * var23 >> 8)
                                 + (var22 * var19 >> 8 << 8)
                                 + (var18 * var21 >> 8 << 16);
                              if (!var33) {
                                 break label103;
                           ...
                           var1[var37 - -var17] = (var26 * var20 >> 8)
                              + (var18 * var24 >> 8 << 16)
                              - -(var19 * var25 >> 8 << 8);
                        }
   ...
   private final void a(
      ...
      try {
         ...
         if (var11 > 8) {
            int var23 = (var18 & 65381) >> 8;
            int var24 = var18 & 0xFF;
            int var25 = var13 >> 16 & 0xFF;
            int var26 = 0xFF & var13 >> 8;
                     ...
                     if (var10 != 0) {
                        ...
                        while (var38 < var32 + var31) {
                           ...
                           if (var5 != 0) {
                              var5 = var2[var5];
                              int var21 = var5 & 0xFF;
                              int var20 = 0xFF & var5 >> 8;
                              int var19 = 0xFF & var5 >> 16;
                              if (var20 != var19 || ~var20 != ~var21) {
                                 if (-256 == ~var19 && var20 == var21) {
                                    var17[var7 + var38] = (var25 * var19 >> 8 << 16)
                                       + (var20 * var26 >> 8 << 8)
                                       + (var27 * var21 >> 8);
                                    if (!var34) {
                                       break label109;
                              ...
                              var17[var38 + var7] = (var24 * var21 >> 8)
                                 + (var19 * var22 >> 8 << 16)
                                 + (var23 * var20 >> 8 << 8);
                           }
         ...
         try {
            ...
            if (this.Qb[var6]) {
               ...
               if (-1 != ~(this.G[var6] * var3 % var14)) {
                  var10 = (var14 - var3 * this.G[var6] % var14 << 16) / var3;
               }

               var11 = (var13 << 16) / var4;
               if (0 != this.Sb[var6] * var4 % var13) {
                  var9 = (var13 - this.Sb[var6] * var4 % var13 << 16) / var4;
               }

               var1 += (-1 + (var4 * this.Sb[var6] - -var13)) / var13;
               var12 = (var14 << 16) / var3;
               var2 += (var14 + var3 * this.G[var6] - 1) / var14;
               var3 = (this.R[var6] - (var10 >> 16)) * var3 / var14;
               var4 = var4 * (this.kb[var6] - (var9 >> 16)) / var13;
            }
         ...
         try {
            ...
            if (this.Qb[var1]) {
               ...
               if (-1 != ~(var5 * this.Sb[var1] % var14)) {
                  var10 = (-(this.Sb[var1] * var5 % var14) + var14 << 16) / var5;
               }

               if (-1 != ~(this.G[var1] * var3 % var15)) {
                  var11 = (var15 + -(this.G[var1] * var3 % var15) << 16) / var3;
               }

               var5 = var5 * (this.kb[var1] - (var10 >> 16)) / var14;
               var3 = (-(var11 >> 16) + this.R[var1]) * var3 / var15;
            }
   ...
   final void a(int var1, int var2, int var3, int var4, int var5, int var6) {
      ...
      try {
         ...
         label422: {
            ...
            var19 = var3 + (var18 * var9 + var10 * var17 >> 22);
            var20 = var2 - -(-(var9 * var17) + var10 * var18 >> 22);
            var21 = (var13 * var18 + var14 * var17 >> 22) + var3;
            var22 = var2 + (var18 * var14 - var13 * var17 >> 22);
            var23 = (var17 * var12 + var18 * var11 >> 22) + var3;
            var24 = (-(var17 * var11) + var18 * var12 >> 22) + var2;
            var25 = (var15 * var18 + var17 * var16 >> 22) + var3;
            var26 = var2 - -(var16 * var18 - var15 * var17 >> 22);
         ...
         if (~var26 != ~var20) {
            var36 = (-var51 + var57 << 8) / (var26 + -var20);
            var32 = (-var19 + var25 << 8) / (var26 - var20);
         }
         ...
         label315: {
            ...
            if (var20 != var22) {
               var32 = (var21 + -var19 << 8) / (-var20 + var22);
               var34 = (-var50 + var54 << 8) / (-var20 + var22);
            }
         }
         ...
         if (var22 != var24) {
            var36 = (-var55 + var53 << 8) / (-var22 + var24);
            var32 = (-var21 + var23 << 8) / (var24 + -var22);
         }
         ...
         if (var10000 != var10001) {
            ...
            var34 = (var56 + -var52 << 8) / (-var24 + var26);
         }
         ...
         while (~var28 < ~var77) {
            int var42 = this.Xb[var77] >> 8;
            int var43 = this.t[var77] >> 8;
            if (var48) {
               break;
            }
            ...
            label419: {
               ...
               int var44 = this.M[var77] << 9;
               int var45 = ((this.Tb[var77] << 9) - var44) / (var43 - var42);
               int var46 = this.tb[var77] << 9;
               int var47 = (-var46 + (this.Wb[var77] << 9)) / (-var42 + var43);
               if (~this.lb > ~var43) {
                  var43 = this.lb;
               }
               ...
               label84: {
                  while (-1 < ~var22) {
                     ...
                     label80: {
                        if (var10000 != -1) {
                           label102: {
                              int var23 = var9 >> 16 & 0xFF;
                              int var24 = (65376 & var9) >> 8;
                              int var25 = 0xFF & var9;
   ...
   private final void a(
      ...
      try {
         L++;
         int var20 = (16717586 & var16) >> 16;
         int var21 = (var16 & 65518) >> 8;
                  ...
                  label93: {
                     if (0 != var15) {
                        ...
                        while (var33 < var27 + var26) {
                           ...
                           if (var4 != 0) {
                              int var19 = var4 & 0xFF;
                              int var17 = (var4 & 16769815) >> 16;
                              int var18 = 0xFF & var4 >> 8;
                              if (~var18 == ~var17 && var19 == var18) {
                                 var8[var11 + var33] = (var19 * var22 >> 8)
                                    + (var21 * var18 >> 8 << 8)
                                    + (var20 * var17 >> 8 << 16);
                                 if (!var29) {
                                    break label87;
   ...
   private final void a(
      ...
      try {
         m++;
         int var21 = (16721450 & var2) >> 16;
         int var22 = (65437 & var2) >> 8;
                  ...
                  if (-1 != ~var12) {
                     ...
                     while (~(var29 + var28) < ~var35) {
                        ...
                        if (-1 != var10001) {
                           var3 = var5[var3];
                           int var20 = var3 & 0xFF;
                           int var18 = var3 >> 16 & 0xFF;
                           int var19 = var3 >> 8 & 0xFF;
                           ...
                           var11[var35 - -var15] = (var22 * var19 >> 8 << 8)
                              + (var21 * var18 >> 8 << 16)
                              - -(var24 * var20 >> 8);
                        }
      ...
      try {
         ...
         while (true) {
            if (var6 < var3) {
               ...
               var5[(31 & var7 >> 3) + (var7 >> 9 & 31744) + ((var7 & 63488) >> 6)]++;
               var6++;
               if (!var23) {
                  continue;
               }
                  ...
                  while (-257 < ~var10) {
                     ...
                     if (var31 < var9) {
                        ...
                        while (true) {
                           ...
                           var25[var10] = 263172 + (ib.a(31, var8) << 3) + ib.a(63488, var8 << 6) + ib.a(16252928, var8 << 9);
                           var26[var10] = var9;
                           break;
                        }
         ...
         while (true) {
            ...
            while (var33 < var34) {
               ...
               int var30 = (var29 >> 3 & 31) + ((var29 & 63488) >> 6) + ((16252928 & var29) >> 9);
               ...
               if (-1 == var12) {
                  int var13 = 999999999;
                  int var14 = 0xFF & var29 >> 16;
                  int var15 = 0xFF & var29 >> 8;
                  int var16 = var29 & 0xFF;
                  int var17 = 0;

                  while (256 > var17) {
                     int var18 = var25[var17];
                     int var19 = (16719512 & var18) >> 16;
   ...
   final void a(int var1, int var2, int var3, boolean var4, int var5, int var6, int var7, int var8, int var9, int var10) {
      ...
      try {
         ...
         try {
            ...
            int var14 = 0;
            int var15 = var5 << 16;
            int var16 = (var11 << 16) / var8;
            int var17 = (var12 << 16) / var7;
            int var18 = -(var5 << 16) / var7;
            if (this.Qb[var6]) {
               ...
               if (var21 * var8 % var19 != 0) {
                  var13 = (-(var8 * var21 % var19) + var19 << 16) / var8;
               }

               var1 += var23;
               var15 += var23 * var18;
               if (0 != var22 * var7 % var20) {
                  var14 = (var20 - var7 * var22 % var20 << 16) / var7;
               }

               var8 = (var16 + ((this.kb[var6] << 16) - (var13 + 1))) / var16;
               var7 = ((this.R[var6] << 16) + -var14 - (-var17 + 1)) / var17;
            }
   ...
   final void a(int var1, int var2, byte[] var3, int var4, byte[] var5) {
      ...
      try {
         ...
         while (true) {
            if (var9 + -1 > var11) {
               var10[var11 - -1] = (ib.a(255, var5[var6]) << 16) - -ib.a(65280, var5[var6 - -1] << 8) + ib.a(var5[var6 + 2], 255);
               var6 += 3;
               var11++;
               if (var17) {
                  break;
