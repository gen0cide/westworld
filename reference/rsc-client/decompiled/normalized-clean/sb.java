final class sb extends va {
   ...
   static final sb a(vb var0, int var1, int var2) {
      return var0.l != null && var0.l.length != 0 ? new sb(var0, (int)(var0.i * 256L * var1 / (100 * sa.t)), var2 << 6) : null;
   }
   ...
   private static final int a(
      ...
      while (var5 < var8) {
         ...
         var16 = (var16 << 8) + (var1 - var16) * (var4 & 0xFF);
   ...
   private static final int a(
      ...
      while (var5 < var10) {
         ...
         var18 = (var18 << 8) + (var1 - var18) * (var4 & 0xFF);
   ...
   private static final int a(
      ...
      while (var5 < var7) {
         ...
         var3[var5++] += ((var14 << 8) + (var1 - var14) * (var4 & 0xFF)) * var6 >> 6;
         var4 += var11;
      }
   ...
   private static final int b(
      ...
      while (var5 < var8) {
         ...
         var3[var5++] += ((var15 << 8) + (var1 - var15) * (var4 & 0xFF)) * var6 >> 6;
         var6 += var7;
         var4 += var12;
      }
