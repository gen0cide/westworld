...
final class ca {
   ...
   private final void a(int var1, int var2, int var3, int var4, int var5, int var6, byte var7) {
      ...
      try {
         ...
         while (var9 < this.Db && !var10) {
            if (-1 != ~var3) {
               this.Gb[var9] = this.Gb[var9] + (this.ic[var9] * var3 >> 1095852296);
            }

            if (0 != var4) {
               this.jc[var9] = this.jc[var9] + (var4 * this.ic[var9] >> -706532120);
            }

            if (-1 != ~var5) {
               this.Gb[var9] = this.Gb[var9] + (var5 * this.jc[var9] >> -324256440);
            }

            if (-1 != ~var2) {
               this.ic[var9] = this.ic[var9] + (var2 * this.jc[var9] >> 423792200);
            }

            if (-1 != ~var1) {
               this.jc[var9] = this.jc[var9] + (var1 * this.Gb[var9] >> -1731094840);
            }

            if (-1 != ~var6) {
               this.ic[var9] = this.ic[var9] + (this.Gb[var9] * var6 >> 1779723400);
            }
         ...
         if (~da.K <= ~this.ec && m.j <= this.gc && ~this.x >= ~oa.b && aa.f <= this.j && this.P <= nb.y && this.e >= aa.b) {
            ...
            if (!var21) {
               ...
               while (this.Db > var17) {
                  ...
                  if (var7 != 0) {
                     int var10 = var19 * var11 - -(var12 * var18) >> 1285023887;
                     var19 = -(var18 * var11) + var19 * var12 >> 1814361327;
                     var18 = var10;
                  }

                  int var20 = this.jc[var17] - var5;
                  if (~var6 != -1) {
                     int var23 = var16 * var18 + var20 * var15 >> 1043773743;
                     var20 = -(var18 * var15) + var16 * var20 >> -1543110961;
                     var18 = var23;
                  }

                  if (~var8 != -1) {
                     int var24 = var19 * var14 + -(var13 * var20) >> 2015943439;
                     var20 = var13 * var19 - -(var14 * var20) >> -446444369;
                     var19 = var24;
                  }
   ...
   private final void b(int var1, int var2, int var3, int var4) {
      ...
      try {
         ...
         while (~var5 > ~this.Db) {
            this.Gb[var5] = this.Gb[var5] * var1 >> -1363775576;
            this.ic[var5] = this.ic[var5] * var4 >> -895455096;
            this.jc[var5] = var3 * this.jc[var5] >> -242758104;
            var5++;
            if (var6 || var6) {
               break;
            }
      ...
      try {
         ...
         while (~this.Db < ~var8 && !var9) {
            if (var3 != 0) {
               ...
               int var5 = pa.a[var3];
               int var7 = this.Gb[var8] * var6 + this.ic[var8] * var5 >> -1049305169;
               this.ic[var8] = -(var5 * this.Gb[var8]) + this.ic[var8] * var6 >> -1441854257;
               this.Gb[var8] = var7;
            }
            ...
            if (-1 != ~var2) {
               ...
               int var15 = -(var11 * this.jc[var8]) + var13 * this.ic[var8] >> 1869232655;
               this.jc[var8] = var11 * this.ic[var8] - -(var13 * this.jc[var8]) >> -1067157009;
               this.ic[var8] = var15;
            }
            ...
            if (-1 != ~var4) {
               ...
               int var16 = var12 * this.jc[var8] + this.Gb[var8] * var14 >> -1889761873;
               this.jc[var8] = -(this.Gb[var8] * var12) + this.jc[var8] * var14 >> 89169167;
               this.Gb[var8] = var16;
            }
   ...
   private final void e(int var1) {
      ...
      try {
         l++;
         if (!this.Nb) {
            int var2 = this.Mb * this.Ib >> 434666280;
            int var3 = 0;
