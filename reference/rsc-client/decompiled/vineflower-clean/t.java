final class t {
   ...
   static final void a(int var0, int var1, int var2, int[] var3, int[] var4, int var5, int var6, int var7) {
      ...
      try {
         a++;
         if (var2 < 0) {
            var0 = var4[0xFF & var5 >> -1455207192];
            var1 <<= 2;
            var5 += var1;
            int var8 = var2 / 16;
            int var9 = var8;
            ...
            while (true) {
               if (-1 < ~var9) {
                  ...
                  var3[var6++] = var0;
                  var3[var6++] = var0;
                  var0 = var4[(var5 & 65525) >> 59579400];
                  var5 += var1;
                  var3[var6++] = var0;
                  var3[var6++] = var0;
                  var3[var6++] = var0;
                  var3[var6++] = var0;
                  var0 = var4[(65469 & var5) >> 1966207912];
                  var3[var6++] = var0;
                  var5 += var1;
                  var3[var6++] = var0;
                  var3[var6++] = var0;
                  var3[var6++] = var0;
                  var0 = var4[0xFF & var5 >> 1256567432];
                  var5 += var1;
                  var3[var6++] = var0;
                  var3[var6++] = var0;
                  var3[var6++] = var0;
                  var3[var6++] = var0;
                  var0 = var4[(65330 & var5) >> 1042063560];
                  var5 += var1;
                  var9++;
                  if (var10) {
                     break;
