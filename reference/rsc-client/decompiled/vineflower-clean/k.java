final class k {
   ...
   static final byte[] a(int var0, boolean var1, byte[] var2) {
      try {
         ...
         int var3 = ((var2[1] & 255) << 1420085512) + ((0xFF0000 & var2[0] << -421308816) - -(255 & var2[2]));
   ...
   final int f(int var1, int var2, int var3) {
      try {
         k++;
         int var4 = var1 >> -1924199641;
         int var5 = var2 >> -1127688185;
   ...
   private final void a(int var1, byte var2, int var3, int var4, int var5, int var6) {
      try {
         ...
         var9 = var9 >> 1085422433 & 8355711;
         int var11 = this.c.a(var3, true);
         var11 = (16711423 & var11) >> 43967169;
         if (var1 == 0) {
