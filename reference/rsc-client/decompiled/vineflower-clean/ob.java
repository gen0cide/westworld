      ...
      try {
         ...
         synchronized (this.f) {
            ...
            try {
               ...
               int var4 = (0xFF00 & la.c[1] << 1647444456) + ((255 & la.c[0]) << -463794928) + (255 & la.c[2]);
               int var5 = (la.c[4] << 553924200 & 0xFF00) + ((la.c[3] & 255) << -1798669456) - -(255 & la.c[5]);
               ...
               while (var4 > var7) {
                  ...
                  label194: {
                     ...
                     if (var2 > 65535) {
                        ...
                        var10 = (la.c[3] & 255) + (la.c[0] << -854702312 & 0xFF000000) - -(0xFF0000 & la.c[1] << -511327312) + (0xFF00 & la.c[2] << 2104943048);
                        var13 = la.c[9] & 255;
                        var11 = (la.c[5] & 255) + ((255 & la.c[4]) << 110659720);
                        var12 = (la.c[8] & 255) + (0xFF0000 & la.c[6] << -1936015824) + (la.c[7] << 2101716552 & 0xFF00);
                        if (!var18) {
                           break label194;
                        }
                     }
                     ...
                     var13 = la.c[7] & 255;
                     var10 = (la.c[0] << 524989928 & 0xFF00) + (255 & la.c[1]);
                     var11 = (la.c[2] << -1311007928 & 0xFF00) + (la.c[3] & 255);
                     var12 = ((255 & la.c[4]) << 862358512) - -((la.c[5] & 255) << 550121000) - -(255 & la.c[6]);
                  }
         ...
         synchronized (this.f) {
            ...
            try {
               ...
               if (var3) {
                  ...
                  this.b.a(var1 * 6, -124);
                  this.b.a(true, 6, 0, la.c);
                  var7 = (255 & la.c[5]) + (la.c[3] << 4539376 & 0xFF0000) - -((la.c[4] & 255) << 1519652136);
               ...
               la.c[0] = (byte)(var4 >> 1377278608);
               la.c[2] = (byte)var4;
               la.c[3] = (byte)(var7 >> -340974608);
               la.c[var5] = (byte)(var7 >> -1558555128);
               la.c[1] = (byte)(var4 >> -236170680);
               la.c[5] = (byte)var7;
               this.b.a(6 * var1, 31);
               ...
               while (~var8 > ~var4) {
                  ...
                  if (var3) {
                     ...
                     label207: {
                        ...
                        if (var1 <= 65535) {
                           ...
                           var11 = (0xFF00 & la.c[0] << -1162714328) - -(la.c[1] & 255);
                           var10 = (la.c[6] & 255) + (0xFF0000 & la.c[4] << -165446384) - -((255 & la.c[5]) << -892700824);
                           var13 = 255 & la.c[7];
                           var12 = (la.c[3] & 255) + (la.c[2] << -941949624 & 0xFF00);
                           if (!var16) {
                              break label207;
                           }
                        }
                        ...
                        var12 = (255 & la.c[5]) + (la.c[4] << -1447609528 & 0xFF00);
                        var10 = (la.c[6] << 725235568 & 0xFF0000) - -((la.c[7] & 255) << 221297448) + (la.c[8] & 255);
                        var11 = (la.c[0] << -2111158472 & 0xFF000000)
                           + ((la.c[1] << -1296842608 & 0xFF0000) - -((255 & la.c[2]) << -1391218456))
                           - -(255 & la.c[3]);
                        var13 = 255 & la.c[9];
                     }
                  ...
                  label208: {
                     if (-65536 > ~var1) {
                        la.c[0] = (byte)(var1 >> -322435432);
                        la.c[5] = (byte)var9;
                        la.c[2] = (byte)(var1 >> -936822456);
                        la.c[4] = (byte)(var9 >> 521649416);
                        la.c[7] = (byte)(var10 >> -876359160);
                        la.c[1] = (byte)(var1 >> 527626448);
                        la.c[8] = (byte)var10;
                        la.c[9] = (byte)this.c;
                        la.c[3] = (byte)var1;
                        la.c[6] = (byte)(var10 >> -1755814992);
                     ...
                     la.c[4] = (byte)(var10 >> 1803659792);
                     la.c[0] = (byte)(var1 >> -566551576);
                     la.c[7] = (byte)this.c;
                     la.c[6] = (byte)var10;
                     la.c[3] = (byte)var9;
                     la.c[1] = (byte)var1;
                     la.c[2] = (byte)(var9 >> -447508120);
                     la.c[5] = (byte)(var10 >> -1738018904);
