...
- **Location:** `mesa/cmd/mesad/main.go:199` (`gs.GracefulStop`) interacting with `mesa/mesad/server.go:589-616` (Subscribe).
...
- **Location:** `mesa/mesad/cron.go:423-435,472-484` (`consolidateSystem`, `Cache:true`, on Haiku) and `mesa/mesad/cron_insight.go:392-409,459-471` (`insightSystem`, `Cache:true`, on Sonnet); model wiring `mesa/cmd/mesad/main.go:53-54`.
