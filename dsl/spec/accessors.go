...
var Accessors = []AccessorSpec{
	...
	{Path: []string{"inventory", "is_full"}, Kind: "bool", DocSummary: "True iff free == 0.", NotYetImplemented: true},
	{Path: []string{"inventory", "find"}, Kind: "callable(item)->ItemView?", DocSummary: "First matching slot, or null.", NotYetImplemented: true},
