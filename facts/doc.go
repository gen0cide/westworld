...
//
// The production path is LoadStatic: defs/locs are checked-in Go tables
// generated by cmd/defsgen from OpenRSC's conf/server/defs/ files and
// constants/*.java (go generate ./facts) — zero runtime file I/O. The
// file-parsing Load remains for tooling and the parity test. Treat all
// of it as immutable once built.
//
