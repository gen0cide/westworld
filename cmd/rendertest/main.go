...
func main() {
	...
	shots := []shot{
		{"lumbridge", render.View{X: 120, Y: 648, Plane: 0, Rotation: 64, Zoom: 750, W: 512, H: 334}, filepath.Join(outDir, "usable1_lumbridge.png")},
		{"jail", render.View{X: 285, Y: 659, Plane: 0, Rotation: 0, Zoom: 750, W: 512, H: 334}, filepath.Join(outDir, "usable1_jail.png")},
	}
